                ...
                <div className="md:col-span-2 space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>Objective</strong>: The D-DAND (Dravet Disease–Associated Neuropsychiatric Disorders) Scale is a new clinicians-administered interview designed to assess the wide range of developmental and behavioral comorbidities in Dravet Syndrome (DS) beyond seizures, and examines its preliminary psychometric properties in a large patient sample. 
                      <strong>Methods</strong>: Caregivers of 123 individuals with Dravet syndrome (age 3–41 years) were interviewed using the D-DAND in a two-phase study. In Phase 1 (N=80), D-DAND domain scores were compared with standard assessments (Vineland Adaptive Behavior Scales, Child Behavior Checklist, Childhood Autism Rating Scale, Behavior Rating Inventory of Executive Function, Sleep Disturbance Scale for Children). In Phase 2 (N=43), D-DAND was re-administered after ~2 weeks to evaluate test–retest reliability. 
                      <strong>Results</strong>: The D-DAND captured a broad spectrum of abilities and problems across multiple functional domains. Test–retest reliability was excellent (overall score r≈0.98; median domain r≈0.89). D-DAND scores showed expected correlations with corresponding standardized measures (e.g., higher D-DAND adaptive scores with higher Vineland scores). Notably, minimal correlations in certain domains indicate that D-DAND measures unique Dravet-specific features not detected by generic scales. 
                      <strong>Significance</strong>: D-DAND is a novel, reliable tool for comprehensive evaluation of Dravet syndrome beyond seizures. It enables systematic tracking of developmental and behavioral issues in DS, facilitating early identification of needs and more personalized, whole-person care.
                    </p>
                  </div>
