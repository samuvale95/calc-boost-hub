                ...
                {scoresPDF.map(({question, response = null, score}) => {
                  return (
                    <View key={question} style={styles.tableRow}>
                      <View style={[styles.tableCell, { flex: 0.25, justifyContent: 'center'}]}>
                        <Text style={styles.tableCellLabel}>{question || 'N/A'}</Text>
                      </View>
                      <View style={[styles.tableCell, { flex: 0.25, justifyContent: 'center', alignItems: 'center' }]}>
                        <Text style={styles.tableCellValue}>{score || 'N/A'}</Text>
                      </View>
                      <View style={[styles.tableCell, { flex: 0.5, justifyContent: 'center' }]}>
