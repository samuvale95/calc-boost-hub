...
È stata implementata una soluzione completa per la gestione dei pagamenti PayPal nell'applicazione DAND, includendo:
...
const paymentRequest: CreatePaymentRequest = {
  ...
  description: 'Abbonamento annuale D-DAND',
  is_renewal: false,
